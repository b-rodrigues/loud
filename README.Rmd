...
You could also use the `%>=%` pipe instead of `bind_loudly()`, once I get it working properly. 
For now it does, but I plan on making things like this work:
...
This packages is in early development, has not a single test and basically is held together with
string and j*zz. Use at your own peril.
